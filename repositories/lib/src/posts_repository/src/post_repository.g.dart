...
class _PostRepository implements PostRepository {
  _PostRepository(this._dio, {this.baseUrl}) {
  ...
  @override
  Future<List<Post>> getPosts({userId, id}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'userId': userId, r'userId': id};
  ...
  @override
  Future<Post> updatePost({required id, required post}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
